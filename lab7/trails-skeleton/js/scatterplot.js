class Scatterplot {
  ...
  initVis() {
    ...
    // Initialize symbol scale
    vis.symbolScale = d3.scaleOrdinal()
        .range([
          d3.symbol().type(d3.symbolCircle).size(40)(),
          d3.symbol().type(d3.symbolSquare).size(40)(),
          d3.symbol().type(d3.symbolDiamond).size(40)()
        ])
